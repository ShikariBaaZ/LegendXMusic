...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ShikariSupportNetwork")
                await self.one.join_chat("The_SHIKARI_Network")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ShikariSupportNetwork")
                await self.two.join_chat("The_SHIKARI_Network")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("ShikariSupportNetwork")
                await self.three.join_chat("The_SHIKARI_Network")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("ShikariSupportNetwork")
                await self.four.join_chat("The_SHIKARI_Network")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("ShikariSupportNetwork")
                await self.five.join_chat("The_SHIKARI_Network")
            except:
                pass
            assistants.append(5)
